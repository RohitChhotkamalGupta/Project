...
<form id="dynamic-form" action="/ProjectBackup/ResponceController" method="post">
 <div id="form-container">
  <%String quizattempter = request.getParameter("quizattempter"); %>
	...
	<input type="text" id = "formname" name="formname" value="12" hidden>
  
        <br>Question : <label for="add-label">hello</label><br>
      
        <input type="radio" id = "True" value="True" name="11">
        <label for="True">True</label><br>
      
        <input type="radio" id = "False" value="False" name="11">
