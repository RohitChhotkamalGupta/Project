...
<form id="dynamic-form" action="/ProjectBackup/ResponceController" method="post">
 <div id="form-container">
  <%String quizattempter = request.getParameter("quizattempter"); %>
	...
	<input type="text" id = "formname" name="formname" value="Rohittt" hidden>
  
        <br>Question : <label for="add-label">Who is the Creator of this Web application?</label><br>
      
        <input type="checkbox" name="Rohit ">
        <label>Rohit </label><br>
      
        <input type="checkbox" name="Srinidhi">
        <label>Srinidhi</label><br>
      
        <input type="checkbox" name="Vinayak ">
        <label>Vinayak </label><br>
      
        <input type="checkbox" name="Nasiruddin">
        <label>Nasiruddin</label><br>
