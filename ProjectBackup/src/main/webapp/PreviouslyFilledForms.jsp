...
<body>
	...
	<nav>
		<ul>
			...
			<li><a href="LoginForJoiningQuiz.jsp">Exit</a></li>
		</ul>
	</nav>
	<div class="container">
		<table class="table table-striped">
			...
			<tbody>
				<%try {
					...
					String sql = "select * from responce where quizattempter='" + quizattempter + "'";
				...
				<tr>
					...
					<td>
						<% String formcreator = rs.getString("formcreator"); %> 
						<input name="formcreator" type="text" value="<%=formcreator%>" readonly="readonly">
					</td>
					<td>
						<% quizattempter = rs.getString("quizattempter"); %> 
					...
					<td>
						...
						<input name="marks" type="number" value="<%=marks%>" readonly="readonly"> 
					</td>
				</tr>
				<%
				}
